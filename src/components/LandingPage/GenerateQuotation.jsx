            ...
            <div className='
                ...
                <div className='grid grid-cols-12 lg:grid-cols-10 gap-2 px-2'>
                    ...
                    {QuotationConfig.map((item, index) => {
                        return(
                            <div key={index} className='col-span-6 sm:col-span-3 min-w-[8rem] lg:col-span-2 border-2 border-[#DBE3FF] h-[240px] p-2 rounded-3xl bg-[#F5F7FE] hover:bg-primary-50 transition cursor-pointer'>
