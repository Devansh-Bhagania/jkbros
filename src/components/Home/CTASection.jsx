  ...
  return (
    <div className='w-[100svw] flex justify-center'>
        <div className='lg:w-[80%] w-[90%] mt-[2rem]'>
            ...
            <div className='w-[100%] flex gap-x-4 md:flex-row flex-col md:items-start items-center'>
                ...
                <div className='grid grid-cols-12 gap-4 md:gap-4 w-[65%] md:items-center items-center justify-center md:justify-start md:mt-6'>
                    {CTASectionCards.map((item, index) => {
                        return(
                            ...
                            <div className='bg-[#F5F7FE] sm:col-span-6 col-span-12 max-w-[20rem] min-w-[6rem] max-h-[16rem] min-h-[13rem] p-6 border-2 border-[#DBE3FF] rounded-3xl cursor-pointer hover:bg-[#D8E3FF] transition'>
                                <img src={item.imgUrl} className='min-h-[80%] max-h-[80%]'/>
                                <h1 className='m-auto w-full text-center py-[1rem] font-semibold text-textPrimary h-[10%]'>{item.title}</h1>
                            </div>
                        )
                    })}
                </div>
                ...
                <div className='md:w-[40%] w-[90%] min-w-[20rem] mt-[2rem] md:mt-[-4rem]'>
                    <div className='bg-[#F5F7FE] w-[100%] min-h-max border-2 border-[#D8E3FF] rounded-3xl p-8'>
                        ...
                        <form className='md:pt-6 pt-4 flex flex-col gap-y-4' onSubmit={handleSubmit}>
                                ...
                                <div className='flex justify-left items-center gap-2'>
                                    <input type="checkbox" className='w-[1rem] h-[1rem]' 
                                        onChange={() => setFormData({...formData, movingFromHasLift: !formData.movingFromHasLift})}/>
                                    <label for="fromLocation" className="text-md text-gray-400">Has service lift?</label>
                                </div>   
                                ...
                                <div className='flex justify-left items-center gap-2'>
                                    <input type="checkbox" name="movingFromHasLift" className='w-[1rem] h-[1rem]' 
                                        onChange={() => setFormData({...formData, movingToHasLift: !formData.movingToHasLift})}/>
                                    <label for="movingFromHasLift" className="text-md text-gray-400">Has service lift?</label>
                                </div>   
            ...
            <ModalsUI {...{SetSelectItemsModal, selectItemsModal, steps, setSteps, formData}}/>                            
        </div>
    </div>
  )
}
